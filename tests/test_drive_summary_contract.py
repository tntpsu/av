...
def test_drive_summary_contract_keys(tmp_path: Path) -> None:
    ...
    assert {
        ...
        "track_source_mode",
        "raw_detect_rate_pct",
        "same_lane_association_rate_pct",
        "continuity_hold_rate_pct",
        "continuity_hold_reason_mode",
        "continuity_drop_reason_mode",
        "continuity_hold_age_p95_ms",
        "continuity_hold_confidence_p50",
        "issue_detected",
        "issue_mode",
    ...
    assert {
        ...
        "mpc_bias_cancellation_on_high_error_rate",
        "rearm_cycle_issue_detected",
        "mpc_bias_cancellation_issue_detected",
        "lateral_error_abs_m",
