...
class AVStack:
    ...
    # NMPC nmpc_q_lat: base=10.0 at same reference (15 m/s, κ=0.002).
    #   NMPC base is high (10.0) for tight curve tracking where MPC is primary.
    #   At 21 m/s autobahn: ratio=1.96 → nmpc_q_lat=19.6.
    #   At 12 m/s hill_highway κ=0.010: ratio=3.2 → nmpc_q_lat=32.0.
