...
class RegimeConfig:
    ...
    upshift_hysteresis_mps: float = 1.0        # Must exceed threshold + this to upshift
    downshift_hysteresis_mps: float = 1.0      # Must drop below threshold − this to downshift
    blend_frames: int = 15                     # Frames to linearly blend at transition
