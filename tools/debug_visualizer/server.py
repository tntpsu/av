        ...
        with h5py.File(filepath, 'r') as f:
            ...
            if vehicle_idx is not None:
                sync_vehicle_fields = {
                    ...
                    'sync_packet_selection_result': ('vehicle/sync_packet_selection_result', 'str'),
                    ...
                    'sync_packet_join_failure_reason_code': ('vehicle/sync_packet_join_failure_reason_code', 'str'),
                    'sync_packet_join_failure_side_code': ('vehicle/sync_packet_join_failure_side_code', 'str'),
                    'sync_packet_selected_failure_contract_reason_code': ('vehicle/sync_packet_selected_failure_contract_reason_code', 'str'),
                    'sync_packet_selected_failure_source_stage_code': ('vehicle/sync_packet_selected_failure_source_stage_code', 'str'),
                    'sync_packet_source_key_present_camera': ('vehicle/sync_packet_source_key_present_camera', 'tri_bool'),
                    'sync_packet_source_key_present_vehicle': ('vehicle/sync_packet_source_key_present_vehicle', 'tri_bool'),
                    'sync_packet_selected_packet_key': ('vehicle/sync_packet_selected_packet_key', 'str'),
                    'sync_packet_timeout_event_delta': ('vehicle/sync_packet_timeout_event_delta', 'int'),
                    'sync_packet_coherence_pass': ('vehicle/sync_packet_coherence_pass', 'tri_bool'),
                    'sync_packet_coherence_reason_code': ('vehicle/sync_packet_coherence_reason_code', 'str'),
                    'sync_packet_complete_but_incoherent': ('vehicle/sync_packet_complete_but_incoherent', 'tri_bool'),
                    'sync_packet_front_vehicle_time_delta_budget_exceeded': ('vehicle/sync_packet_front_vehicle_time_delta_budget_exceeded', 'tri_bool'),
                    'sync_packet_front_vehicle_frame_delta_budget_exceeded': ('vehicle/sync_packet_front_vehicle_frame_delta_budget_exceeded', 'tri_bool'),
                    'sync_packet_join_wait_budget_exceeded': ('vehicle/sync_packet_join_wait_budget_exceeded', 'tri_bool'),
                    'sync_packet_component_age_budget_exceeded': ('vehicle/sync_packet_component_age_budget_exceeded', 'tri_bool'),
                    'sync_packet_source_context_queue_depth': ('vehicle/sync_packet_source_context_queue_depth', 'int'),
                    'sync_packet_source_context_dropped_stale_count': ('vehicle/sync_packet_source_context_dropped_stale_count', 'int'),
                    'sync_packet_source_context_missing_count': ('vehicle/sync_packet_source_context_missing_count', 'int'),
                    'sync_packet_source_context_frame_delta': ('vehicle/sync_packet_source_context_frame_delta', 'float'),
                    'sync_packet_source_context_time_delta_ms': ('vehicle/sync_packet_source_context_time_delta_ms', 'float'),
                    'sync_packet_source_bundle_close_reason': ('vehicle/sync_packet_source_bundle_close_reason', 'str'),
                    'sync_packet_source_bundle_deadline_ms': ('vehicle/sync_packet_source_bundle_deadline_ms', 'float'),
                    'sync_packet_source_bundle_age_ms': ('vehicle/sync_packet_source_bundle_age_ms', 'float'),
                    'sync_packet_source_bundle_inflight_count': ('vehicle/sync_packet_source_bundle_inflight_count', 'int'),
                    'sync_packet_source_bundle_vehicle_state_built': ('vehicle/sync_packet_source_bundle_vehicle_state_built', 'tri_bool'),
                    'sync_packet_source_bundle_vehicle_state_enqueued': ('vehicle/sync_packet_source_bundle_vehicle_state_enqueued', 'tri_bool'),
                    'sync_packet_source_bundle_vehicle_state_sent': ('vehicle/sync_packet_source_bundle_vehicle_state_sent', 'tri_bool'),
                    'sync_packet_source_bundle_camera_requested': ('vehicle/sync_packet_source_bundle_camera_requested', 'tri_bool'),
                    'sync_packet_source_camera_request_attempted': ('vehicle/sync_packet_source_camera_request_attempted', 'tri_bool'),
                    'sync_packet_source_camera_request_accepted': ('vehicle/sync_packet_source_camera_request_accepted', 'tri_bool'),
                    'sync_packet_source_camera_request_rejected_reason': ('vehicle/sync_packet_source_camera_request_rejected_reason', 'str'),
                    'sync_packet_source_camera_request_skipped_reason': ('vehicle/sync_packet_source_camera_request_skipped_reason', 'str'),
                    'sync_packet_source_camera_request_disposition_code': ('vehicle/sync_packet_source_camera_request_disposition_code', 'str'),
                    'sync_packet_source_camera_request_attempt_age_ms': ('vehicle/sync_packet_source_camera_request_attempt_age_ms', 'float'),
                    'sync_packet_source_camera_request_accept_age_ms': ('vehicle/sync_packet_source_camera_request_accept_age_ms', 'float'),
                    'sync_packet_source_camera_request_queue_depth': ('vehicle/sync_packet_source_camera_request_queue_depth', 'int'),
                    'sync_packet_source_bundle_active_transport_eligible': ('vehicle/sync_packet_source_bundle_active_transport_eligible', 'tri_bool'),
                    'sync_packet_source_bundle_debug_unbundled_capture': ('vehicle/sync_packet_source_bundle_debug_unbundled_capture', 'tri_bool'),
                    'sync_packet_camera_capture_contract_reason': ('vehicle/sync_packet_camera_capture_contract_reason', 'str'),
                    'sync_packet_source_bundle_camera_sent': ('vehicle/sync_packet_source_bundle_camera_sent', 'tri_bool'),
                    'sync_packet_source_bundle_aborted_before_vehicle_send': ('vehicle/sync_packet_source_bundle_aborted_before_vehicle_send', 'tri_bool'),
                    'sync_packet_source_bundle_abort_reason': ('vehicle/sync_packet_source_bundle_abort_reason', 'str'),
                    'sync_packet_source_vehicle_send_blocked_by_camera_request': ('vehicle/sync_packet_source_vehicle_send_blocked_by_camera_request', 'tri_bool'),
                    'sync_packet_source_bundle_superseded_before_send': ('vehicle/sync_packet_source_bundle_superseded_before_send', 'tri_bool'),
                    'sync_packet_active_camera_excluded_event_delta': ('vehicle/sync_packet_active_camera_excluded_event_delta', 'int'),
                    'sync_packet_active_camera_excluded_reason_code': ('vehicle/sync_packet_active_camera_excluded_reason_code', 'str'),
                    'sync_packet_unbundled_camera_entered_active_path_event_delta': ('vehicle/sync_packet_unbundled_camera_entered_active_path_event_delta', 'int'),
